...
public interface ExecuteActiveListener {
    ...
    /**
     * Called during the execution of an ExecuteActive, when a new operation is found and has to be executed
     *
    ...
    /**
     * During an ExecuteActive execution, if a new session is found, this function is called, with the session as an
     * argument. You can return the session initiating it
     *
     * @param s the session
