...
public class Track {
    ...
    /**
     * Updates the indexes of the first and last element of the track. This function has to be called each time the
     * list is updated.
     */
     ...
     */
    public List<SessionTrackAction> getStasFromMarkers(String markerFrom,
                                                       String markerTo,
                                                       boolean is_from_included,
                                                       boolean is_to_included) throws ParsingException {
    ...
    public void mark(SessionTrackAction to_be_marked,
                     String marker_name) throws ParsingException {
